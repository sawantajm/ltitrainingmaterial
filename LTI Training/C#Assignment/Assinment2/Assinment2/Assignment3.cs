       ...
       static void Main()
        {
            ...
            Console.WriteLine("Enter the scores  of last five matches");

            Console.WriteLine("Enter the match one score");

            int match1 = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Enter the match two score");

            int match2 = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Enter the match three score");

            int match3 = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Enter the match four score");

            int match4 = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Enter the match five score");

            int match5 = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("total runs scored ");
            int totalRun = match1 + match2 + match3 + match4 + match5;
            Console.WriteLine("Total runs:" + total);

            Console.WriteLine("average runs scored by the batsman");

            int Average = (totalRun / 5);

            Console.WriteLine("average runs: " + Average);
